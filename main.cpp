...
class MessageHander {
public:
    virtual LRESULT HandleMessage(HWND hWnd, WPARAM wParam, LPARAM lParam) = 0;
};

//WM_COMMAND
class CommandMessage : public MessageHander {
public:
    LRESULT HandleMessage(HWND hWnd, WPARAM wParam, LPARAM lParam) override {
...
//WM_PAINT
class PaintMessage : public MessageHander {
public:
    LRESULT HandleMessage(HWND hWnd, WPARAM wParam, LPARAM lParam) override {
        PAINTSTRUCT ps;
...
//WM_DESTROY
class DestroyMessage : public MessageHander {
public:
    LRESULT HandleMessage(HWND hWnd, WPARAM wParam, LPARAM lParam) override {
        PostQuitMessage(0);
        return 0;
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    if (it != messageHandlers.end()) {
        return it->second->HandleMessage(hWnd, wParam, lParam);
    }
    else {
